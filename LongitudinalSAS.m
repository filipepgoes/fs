...
while isim ==1
    ...
    if ictr == 1
        ...
        disp('2 - Projeto por alocaçao de polos, realimentaçao de estado');
        disp('3 - Projeto por alocaçao de polos, realimentaçao de saida');
        itipo = input('Opçao: ');
        disp ' '
        if itipo == 1
            % LQR
...
%     dpif = input(' dpif (%)= '); dpif = dpif/100;
    ...
    % simulaçao da dinamica longitudinal sem controle
    aux = ictr; ictr = 0;
    ...
    % simulaçao da dinamica longitudinal com controle ou linear
    if ictr == 1
